...
from cs336_basics.transformers.module import Embedding, Linear, RMSNorm, RotaryPositionalEmbedding, Softmax, SwiGLU
...
def run_swiglu(
    ...
    swiglu.gate_proj.weights.data = w1_weight
    swiglu.down_proj.weights.data = w2_weight
    swiglu.up_proj.weights.data = w3_weight
...
def run_train_bpe(
    ...
    **kwargs,
    ...
    tokenizer = Tokenizer(
        ...
        chunk_boundary=kwargs.get("chunk_boundary", b"<|endoftext|>"),
    )
